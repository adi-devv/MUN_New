...
const Brands = () => (
  <section className="pt-16 container flex justify-center bg-gray-light px-8 py-8 dark:bg-gray-dark sm:px-10 md:px-[50px] md:py-[40px] xl:p-[50px] 2xl:px-[70px] 2xl:py-[60px]">
    <a
      target="_blank"
...
//         target="_blank"
//         rel="nofollow noreferrer"
//         className="relative h-10 w-full opacity-70 transition hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 " style={{height:"100px", width:"170px"}}
//       >
